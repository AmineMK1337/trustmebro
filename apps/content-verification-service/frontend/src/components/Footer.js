        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                <div className="overflow-hidden rounded-full">
                  <img 
                    src="/assets/trust-me-bro.png" 
                    alt="Trust Me Bro Logo" 
                    className="h-8 w-8 object-cover"
                  />
                </div>
                <span className="text-xl font-bold text-white">Trust Me Bro</span>
              </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a 
                    href="mailto:deepsafe.hq@gmail.com?subject=Trust Me Bro Enterprise Inquiry"
            ...
            <div className="space-y-4">
              ...
              <p className="text-xs text-neutral-500">
                Trust Me Bro is continuously improving. Report issues on our GitHub repository.
              </p>
            </div>
          </div>
          ...
          <div className="mt-8 pt-8 border-t border-neutral-700/50 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            <div className="text-sm text-neutral-500">
              © {currentYear} Trust Me Bro. All rights reserved.
            </div>
