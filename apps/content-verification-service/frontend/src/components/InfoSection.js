      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-4 max-w-2xl text-xl text-neutral-500 dark:text-neutral-400 lg:mx-auto">
            Trust Me Bro leverages a cutting-edge AI ensemble, featuring an advanced Stacking meta-learner, to protect against digital deception with industry-leading accuracy.
          </p>
        </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-primary-600 to-primary-700 dark:from-primary-700 dark:to-primary-800 rounded-2xl shadow-xl p-8 text-center text-white">
          <h3 className="text-2xl font-bold mb-4">Trust Me Bro Performance Highlights</h3>
        ...
        <div className="mt-16 text-center">
          ...
          <p className="mt-4 text-lg text-neutral-600 dark:text-neutral-400 max-w-3xl mx-auto">
            In an era of rapidly advancing generative AI, Trust Me Bro provides a critical layer of defense against digital deception. Our ongoing research and development ensure that our detection capabilities evolve alongside emerging manipulation methods.
          </p>
